...
class Demo_LLampuga():
    ...
    def evaluation(self, number_of_images, confussion, directory='/eval_result'):
        # Compute VOC-Style mAP @ IoU=0.5
        # Running on 'number_of_images' images. Increase for better accuracy.
        image_ids = np.array(self.dataset_val.image_ids) #np.random.choice(self.dataset_val.image_ids, number_of_images)
...
class automatiscm():
    ...
    def evaluation(self, number_of_images, confusion,directory):
        self.demo.evaluation(number_of_images=number_of_images, confussion=confusion, directory=directory)
    ...
    def parse_arguments(self):
        ...
        parser.add_argument('--image_num', type=int, default=3, help='Number of images to process in evaluation')
    ...
    def main(self):
        ...
        if mode == "training":
            ...
            self.evaluation(directory=args.directory,confusion=args.not_confusion, number_of_images=args.image_num)
