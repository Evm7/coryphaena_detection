...
class Config(object):
    ...
    NUM_CLASSES = 27  # Override in sub-classes
    ...
    def display(self):
        ...
        print("\n")
    ##added by Amaya Alvarez
    def save(self,log_dir,date):
                
        name_of_file = ("Config_" + date)
        completeName = os.path.join(log_dir,name_of_file + ".txt")     #os.path.join(log_dir,    
